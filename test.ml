module MyLearner = Type3Learner.Make(struct
        ...
        let feature2string = function (a,b) -> b ^ a
end)

(* define a paradigm over 2 binary features A and B*)
let m1 = list2monomial [("A","+"); ("B","-")];;
let m2 = list2monomial [("A","+"); ("B","+")];;
let m3 = list2monomial [("A","-"); ("B","+")];;
let m4 = list2monomial [("A","-"); ("B","-")];;
...
let e1 = list2monomial [("A","+"); ("B","+")]
let e2 = list2monomial [("A","-"); ("B","+")]
let e3 = list2monomial [("A","+"); ("B","-")]
let e4 = list2monomial [("A","-"); ("B","-")]
let eA = list2monomial [("A","+")]
...
let m1 = list2monomial [("A","+"); ("B","-")]
let m2 = list2monomial [("B","-"); ("G","+"); ("A","-")]
let m3 = list2monomial [("C","+"); ("A","-")]
let m4 = list2monomial [("D","+"); ("I","-"); ("J","-"); ("K","-")]
let m5 = list2monomial [("E","+"); ("A","-")]
let m6 = list2monomial [("A","-"); ("E","+")]
let m7 = list2monomial [("A","-"); ("E","+")];;

assert  (not (m1 = m2));;
assert  (m1 = m1);;
assert  (m6 = m7);;

let e = list2monomial [("A","+"); ("B","-"); ("C","+"); ("D","-"); ("E","-"); ("A","-")];;

assert  (compare_dissim_to e m1 m3 = -(compare 2 2));;
assert  (compare_dissim_to e m2 (list2monomial []) = -(compare 2 0));;
